...
namespace MyProjectSite.Controllers
{
    public class CheckOutController : Controller
    {
        ...
        public ActionResult PlaceOrder(FormCollection getCheckoutDetails)
        {
            ...
            int shpID = 1;
            if (db.ShippingAddresss.Count() > 0)
            {
                shpID = db.ShippingAddresss.Max(x => x.ShippingID) + 1;
            }
            int payID = 1;
            ...
            ShippingAddress shpDetails = new ShippingAddress();
            ...
            db.ShippingAddresss.Add(shpDetails);
            db.SaveChanges();
